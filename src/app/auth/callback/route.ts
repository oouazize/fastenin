...
import getLogger from 'src/theme/logger';
import { paths } from 'src/routes/paths';
import getSupabaseRouteHandlerClient from 'src/lib/supabase/route-handler-client';
...
export async function GET(request: NextRequest) {
  ...
  const nextUrl = searchParams.get('next') ?? paths.dashboard.root;
